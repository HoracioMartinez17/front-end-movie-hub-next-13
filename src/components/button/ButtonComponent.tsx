...
interface IconButtonProps {
    ...
    className?: string;
    children: ReactNode;
    backgroundColor?: 'greenBackground' | 'redBackground' |'blackBackground' | 'yellowBackground';
    button_hover?: 'button_hover_red' | 'button_hover_green' | 'button_hover_black' |'button_hover_yello';
